...
var Event;
(function(Event2) {
  Event2.None = () => lifecycle_Disposable.None;
...
function create(key, data) {
  ...
  return {
    ...
    getConfiguredDefaultLocale: (_a = data.getConfiguredDefaultLocale) !== null && _a !== void 0 ? _a : (_) => void 0
  };
}
  ...
  if (!name || name.length === 0) {
    return load2({
      ...
      getConfiguredDefaultLocale: () => {
        var _a2;
        return (_a2 = pluginConfig.availableLanguages) === null || _a2 === void 0 ? void 0 : _a2["*"];
      }
    });
  }
    ...
    (async () => {
      ...
      try {
        ...
        try {
          ...
          (_a2 = pluginConfig.availableLanguages) !== null && _a2 !== void 0 ? _a2 : pluginConfig.availableLanguages = {};
...
/* provided dependency */ var process = __webpack_require__(461);
var _a, _b;
...
const OS = (/* unused pure expression or super */ null && (_isMacintosh || _isIOS ? 2 : _isWindows ? 1 : 3));
...
/* provided dependency */ var process_process = __webpack_require__(461);
...
if (typeof vscodeGlobal !== "undefined" && typeof vscodeGlobal.process !== "undefined") {
  ...
  safeProcess = {
    get platform() {
      return process_process.platform;
    },
    get arch() {
      return process_process.arch;
    },
    get env() {
      return process_process.env;
    },
    cwd() {
      return process_process.env["VSCODE_CWD"] || process_process.cwd();
    }
  };
} else {
  safeProcess = {
...
function path_format(sep2, pathObject) {
...
const symbolKindNames = {
  [
    17
    /* SymbolKind.Array */
  ]: nls_localize("Array", "array"),
  [
    16
    /* SymbolKind.Boolean */
  ]: nls_localize("Boolean", "boolean"),
  [
    4
    /* SymbolKind.Class */
  ]: nls_localize("Class", "class"),
  [
    13
    /* SymbolKind.Constant */
  ]: nls_localize("Constant", "constant"),
  [
    8
    /* SymbolKind.Constructor */
  ]: nls_localize("Constructor", "constructor"),
  [
    9
    /* SymbolKind.Enum */
  ]: nls_localize("Enum", "enumeration"),
  [
    21
    /* SymbolKind.EnumMember */
  ]: nls_localize("EnumMember", "enumeration member"),
  [
    23
    /* SymbolKind.Event */
  ]: nls_localize("Event", "event"),
  [
    7
    /* SymbolKind.Field */
  ]: nls_localize("Field", "field"),
  [
    0
    /* SymbolKind.File */
  ]: nls_localize("File", "file"),
  [
    11
    /* SymbolKind.Function */
  ]: nls_localize("Function", "function"),
  [
    10
    /* SymbolKind.Interface */
  ]: nls_localize("Interface", "interface"),
  [
    19
    /* SymbolKind.Key */
  ]: nls_localize("Key", "key"),
  [
    5
    /* SymbolKind.Method */
  ]: nls_localize("Method", "method"),
  [
    1
    /* SymbolKind.Module */
  ]: nls_localize("Module", "module"),
  [
    2
    /* SymbolKind.Namespace */
  ]: nls_localize("Namespace", "namespace"),
  [
    20
    /* SymbolKind.Null */
  ]: nls_localize("Null", "null"),
  [
    15
    /* SymbolKind.Number */
  ]: nls_localize("Number", "number"),
  [
    18
    /* SymbolKind.Object */
  ]: nls_localize("Object", "object"),
  [
    24
    /* SymbolKind.Operator */
  ]: nls_localize("Operator", "operator"),
  [
    3
    /* SymbolKind.Package */
  ]: nls_localize("Package", "package"),
  [
    6
    /* SymbolKind.Property */
  ]: nls_localize("Property", "property"),
  [
    14
    /* SymbolKind.String */
  ]: nls_localize("String", "string"),
  [
    22
    /* SymbolKind.Struct */
  ]: nls_localize("Struct", "struct"),
  [
    25
    /* SymbolKind.TypeParameter */
  ]: nls_localize("TypeParameter", "type parameter"),
  [
    12
    /* SymbolKind.Variable */
  ]: nls_localize("Variable", "variable")
};
  ...
  shouldHighlightNonBasicASCII(character, wordContext) {
    ...
    if (wordContext) {
      for (const char of wordContext) {
        ...
        if (!isBasicASCII && !this.ambiguousCharacters.isAmbiguous(codePoint2) && !InvisibleCharacters.isInvisibleCharacter(codePoint2)) {
...
class LegacyLinesDiffComputer {
  computeDiff(originalLines, modifiedLines, options) {
    ...
    for (const c of result.changes) {
      ...
      let change = new DetailedLineRangeMapping(originalRange, modifiedRange, (_a = c.charChanges) === null || _a === void 0 ? void 0 : _a.map((c2) => new RangeMapping(new range_Range(c2.originalStartLineNumber, c2.originalStartColumn, c2.originalEndLineNumber, c2.originalEndColumn), new range_Range(c2.modifiedStartLineNumber, c2.modifiedStartColumn, c2.modifiedEndLineNumber, c2.modifiedEndColumn))));
      if (lastChange) {
...
/* provided dependency */ var json_worker_process = __webpack_require__(461);
/*!-----------------------------------------------------------------------------
...
var json_worker_localize2 = loadMessageBundle();
var formats = {
  "color-hex": { errorMessage: json_worker_localize2("colorHexFormatWarning", "Invalid color format. Use #RGB, #RGBA, #RRGGBB or #RRGGBBAA."), pattern: /^#([0-9A-Fa-f]{3,4}|([0-9A-Fa-f]{2}){3,4})$/ },
  "date-time": { errorMessage: json_worker_localize2("dateTimeFormatWarning", "String is not a RFC3339 date-time."), pattern: /^(\d{4})-(0[1-9]|1[0-2])-(0[1-9]|[12][0-9]|3[01])T([01][0-9]|2[0-3]):([0-5][0-9]):([0-5][0-9]|60)(\.[0-9]+)?(Z|(\+|-)([01][0-9]|2[0-3]):([0-5][0-9]))$/i },
  "date": { errorMessage: json_worker_localize2("dateFormatWarning", "String is not a RFC3339 date."), pattern: /^(\d{4})-(0[1-9]|1[0-2])-(0[1-9]|[12][0-9]|3[01])$/i },
  "time": { errorMessage: json_worker_localize2("timeFormatWarning", "String is not a RFC3339 time."), pattern: /^([01][0-9]|2[0-3]):([0-5][0-9]):([0-5][0-9]|60)(\.[0-9]+)?(Z|(\+|-)([01][0-9]|2[0-3]):([0-5][0-9]))$/i },
  "email": { errorMessage: json_worker_localize2("emailFormatWarning", "String is not an e-mail address."), pattern: /^(([^<>()\[\]\\.,;:\s@"]+(\.[^<>()\[\]\\.,;:\s@"]+)*)|(".+"))@((\[[0-9]{1,3}\.[0-9]{1,3}\.[0-9]{1,3}\.[0-9]{1,3}])|(([a-zA-Z0-9-]+\.)+[a-zA-Z]{2,}))$/ },
  "hostname": { errorMessage: json_worker_localize2("hostnameFormatWarning", "String is not a hostname."), pattern: /^(?=.{1,253}\.?$)[a-z0-9](?:[a-z0-9-]{0,61}[a-z0-9])?(?:\.[a-z0-9](?:[-0-9a-z]{0,61}[0-9a-z])?)*\.?$/i },
  "ipv4": { errorMessage: json_worker_localize2("ipv4FormatWarning", "String is not an IPv4 address."), pattern: /^(?:(?:25[0-5]|2[0-4]\d|1\d\d|[1-9]?\d)\.){3}(?:25[0-5]|2[0-4]\d|1\d\d|[1-9]?\d)$/ },
  "ipv6": { errorMessage: json_worker_localize2("ipv6FormatWarning", "String is not an IPv6 address."), pattern: /^((([0-9a-f]{1,4}:){7}([0-9a-f]{1,4}|:))|(([0-9a-f]{1,4}:){6}(:[0-9a-f]{1,4}|((25[0-5]|2[0-4]\d|1\d\d|[1-9]?\d)(\.(25[0-5]|2[0-4]\d|1\d\d|[1-9]?\d)){3})|:))|(([0-9a-f]{1,4}:){5}(((:[0-9a-f]{1,4}){1,2})|:((25[0-5]|2[0-4]\d|1\d\d|[1-9]?\d)(\.(25[0-5]|2[0-4]\d|1\d\d|[1-9]?\d)){3})|:))|(([0-9a-f]{1,4}:){4}(((:[0-9a-f]{1,4}){1,3})|((:[0-9a-f]{1,4})?:((25[0-5]|2[0-4]\d|1\d\d|[1-9]?\d)(\.(25[0-5]|2[0-4]\d|1\d\d|[1-9]?\d)){3}))|:))|(([0-9a-f]{1,4}:){3}(((:[0-9a-f]{1,4}){1,4})|((:[0-9a-f]{1,4}){0,2}:((25[0-5]|2[0-4]\d|1\d\d|[1-9]?\d)(\.(25[0-5]|2[0-4]\d|1\d\d|[1-9]?\d)){3}))|:))|(([0-9a-f]{1,4}:){2}(((:[0-9a-f]{1,4}){1,5})|((:[0-9a-f]{1,4}){0,3}:((25[0-5]|2[0-4]\d|1\d\d|[1-9]?\d)(\.(25[0-5]|2[0-4]\d|1\d\d|[1-9]?\d)){3}))|:))|(([0-9a-f]{1,4}:){1}(((:[0-9a-f]{1,4}){1,6})|((:[0-9a-f]{1,4}){0,4}:((25[0-5]|2[0-4]\d|1\d\d|[1-9]?\d)(\.(25[0-5]|2[0-4]\d|1\d\d|[1-9]?\d)){3}))|:))|(:(((:[0-9a-f]{1,4}){1,7})|((:[0-9a-f]{1,4}){0,5}:((25[0-5]|2[0-4]\d|1\d\d|[1-9]?\d)(\.(25[0-5]|2[0-4]\d|1\d\d|[1-9]?\d)){3}))|:)))$/i }
};
var ASTNodeImpl = (
  /** @class */
  function() {
...
function asSchema(schema2) {
  if (json_worker_isBoolean(schema2)) {
    return schema2 ? {} : { "not": {} };
  }
  return schema2;
}
      ...
      if (!this.enumValueMatch && !validationResult.enumValueMatch && this.enumValues && validationResult.enumValues) {
        ...
        for (var _i = 0, _a = this.problems; _i < _a.length; _i++) {
          ...
          if (error.code === ErrorCode.EnumValueMismatch) {
            error.message = json_worker_localize2("enumWarning", "Value is not accepted. Valid values: {0}.", this.enumValues.map(function(v) {
...
function validate(n, schema2, validationResult, matchingSchemas) {
  ...
  function _validateNode() {
    ...
    if (Array.isArray(schema2.type)) {
      if (!schema2.type.some(matchesType)) {
        validationResult.problems.push({
          ...
          message: schema2.errorMessage || json_worker_localize2("typeArrayMismatchWarning", "Incorrect type. Expected one of {0}.", schema2.type.join(", "))
        });
      }
      ...
      if (!matchesType(schema2.type)) {
        validationResult.problems.push({
          location: { offset: node.offset, length: node.length },
          message: schema2.errorMessage || json_worker_localize2("typeMismatchWarning", 'Incorrect type. Expected "{0}".', schema2.type)
        });
      }
    }
    ...
    if (notSchema) {
      ...
      if (!subValidationResult.hasProblems()) {
        validationResult.problems.push({
          location: { offset: node.offset, length: node.length },
          message: json_worker_localize2("notSchemaWarning", "Matches a schema that is not allowed.")
        });
      }
    ...
    var testAlternatives = function(alternatives, maxOneMatch) {
      ...
      if (matches.length > 1 && maxOneMatch) {
        validationResult.problems.push({
          ...
          message: json_worker_localize2("oneOfWarning", "Matches multiple schemas when only one must validate.")
        });
      }
      if (bestMatch) {
    ...
    if (Array.isArray(schema2.enum)) {
      ...
      if (!enumValueMatch) {
        validationResult.problems.push({
          ...
          message: schema2.errorMessage || json_worker_localize2("enumWarning", "Value is not accepted. Valid values: {0}.", schema2.enum.map(function(v) {
            return JSON.stringify(v);
          }).join(", "))
        });
      }
    }
    if (json_worker_isDefined(schema2.const)) {
      var val = getNodeValue3(node);
      if (!json_worker_equals(val, schema2.const)) {
        validationResult.problems.push({
          location: { offset: node.offset, length: node.length },
          code: ErrorCode.EnumValueMismatch,
          message: schema2.errorMessage || json_worker_localize2("constWarning", "Value must be {0}.", JSON.stringify(schema2.const))
        });
  ...
  function _validateNumberNode(node2, schema22, validationResult2, matchingSchemas2) {
    ...
    ;
    if (json_worker_isNumber(schema22.multipleOf)) {
      var remainder = -1;
      ...
      if (remainder !== 0) {
        validationResult2.problems.push({
          ...
          message: json_worker_localize2("multipleOfWarning", "Value is not divisible by {0}.", schema22.multipleOf)
        });
      }
    }
    ...
    if (json_worker_isNumber(exclusiveMinimum) && val <= exclusiveMinimum) {
      validationResult2.problems.push({
        location: { offset: node2.offset, length: node2.length },
        message: json_worker_localize2("exclusiveMinimumWarning", "Value is below the exclusive minimum of {0}.", exclusiveMinimum)
      });
    }
    ...
    if (json_worker_isNumber(exclusiveMaximum) && val >= exclusiveMaximum) {
      validationResult2.problems.push({
        location: { offset: node2.offset, length: node2.length },
        message: json_worker_localize2("exclusiveMaximumWarning", "Value is above the exclusive maximum of {0}.", exclusiveMaximum)
      });
    }
    ...
    if (json_worker_isNumber(minimum) && val < minimum) {
      validationResult2.problems.push({
        location: { offset: node2.offset, length: node2.length },
        message: json_worker_localize2("minimumWarning", "Value is below the minimum of {0}.", minimum)
      });
    }
    ...
    if (json_worker_isNumber(maximum) && val > maximum) {
      validationResult2.problems.push({
        location: { offset: node2.offset, length: node2.length },
        message: json_worker_localize2("maximumWarning", "Value is above the maximum of {0}.", maximum)
      });
    }
  }
  function _validateStringNode(node2, schema22, validationResult2, matchingSchemas2) {
    if (json_worker_isNumber(schema22.minLength) && node2.value.length < schema22.minLength) {
      validationResult2.problems.push({
        location: { offset: node2.offset, length: node2.length },
        message: json_worker_localize2("minLengthWarning", "String is shorter than the minimum length of {0}.", schema22.minLength)
      });
    }
    if (json_worker_isNumber(schema22.maxLength) && node2.value.length > schema22.maxLength) {
      validationResult2.problems.push({
        location: { offset: node2.offset, length: node2.length },
        message: json_worker_localize2("maxLengthWarning", "String is longer than the maximum length of {0}.", schema22.maxLength)
      });
    }
    if (json_worker_isString(schema22.pattern)) {
      var regex = extendedRegExp(schema22.pattern);
      if (!(regex === null || regex === void 0 ? void 0 : regex.test(node2.value))) {
        validationResult2.problems.push({
          location: { offset: node2.offset, length: node2.length },
          message: schema22.patternErrorMessage || schema22.errorMessage || json_worker_localize2("patternWarning", 'String does not match the pattern of "{0}".', schema22.pattern)
        });
      }
    }
    if (schema22.format) {
        ...
        case "uri-reference":
          {
            ...
            if (!node2.value) {
              errorMessage = json_worker_localize2("uriEmpty", "URI expected.");
            } else {
              var match = /^(([^:/?#]+?):)?(\/\/([^/?#]*))?([^?#]*)(\?([^#]*))?(#(.*))?/.exec(node2.value);
              if (!match) {
                errorMessage = json_worker_localize2("uriMissing", "URI is expected.");
              } else if (!match[2] && schema22.format === "uri") {
                errorMessage = json_worker_localize2("uriSchemeMissing", "URI with a scheme is expected.");
              }
            }
            if (errorMessage) {
              validationResult2.problems.push({
                location: { offset: node2.offset, length: node2.length },
                message: schema22.patternErrorMessage || schema22.errorMessage || json_worker_localize2("uriFormatWarning", "String is not a URI: {0}", errorMessage)
              });
            }
          }
          break;
  ...
  function _validateArrayNode(node2, schema22, validationResult2, matchingSchemas2) {
    if (Array.isArray(schema22.items)) {
      ...
      if (node2.items.length > subSchemas.length) {
        if (typeof schema22.additionalItems === "object") {
          ...
          validationResult2.problems.push({
            location: { offset: node2.offset, length: node2.length },
            message: json_worker_localize2("additionalItemsWarning", "Array has too many items according to schema. Expected {0} or fewer.", subSchemas.length)
          });
        }
      }
    } else {
    ...
    if (containsSchema) {
      ...
      if (!doesContain) {
        validationResult2.problems.push({
          location: { offset: node2.offset, length: node2.length },
          message: schema22.errorMessage || json_worker_localize2("requiredItemMissingWarning", "Array does not contain required item.")
        });
      }
    }
    if (json_worker_isNumber(schema22.minItems) && node2.items.length < schema22.minItems) {
      validationResult2.problems.push({
        location: { offset: node2.offset, length: node2.length },
        message: json_worker_localize2("minItemsWarning", "Array has too few items. Expected {0} or more.", schema22.minItems)
      });
    }
    if (json_worker_isNumber(schema22.maxItems) && node2.items.length > schema22.maxItems) {
      validationResult2.problems.push({
        location: { offset: node2.offset, length: node2.length },
        message: json_worker_localize2("maxItemsWarning", "Array has too many items. Expected {0} or fewer.", schema22.maxItems)
      });
    }
    if (schema22.uniqueItems === true) {
      ...
      if (duplicates) {
        validationResult2.problems.push({
          location: { offset: node2.offset, length: node2.length },
          message: json_worker_localize2("uniqueItemsWarning", "Array has duplicate items.")
        });
      }
    }
  }
  function _validateObjectNode(node2, schema22, validationResult2, matchingSchemas2) {
    ...
    if (Array.isArray(schema22.required)) {
      for (var _b = 0, _c = schema22.required; _b < _c.length; _b++) {
        ...
        if (!seenKeys[propertyName]) {
          ...
          validationResult2.problems.push({
            location,
            message: json_worker_localize2("MissingRequiredPropWarning", 'Missing property "{0}".', propertyName)
          });
        }
      }
    }
          ...
          if (json_worker_isBoolean(propertySchema)) {
            if (!propertySchema) {
              ...
              validationResult2.problems.push({
                ...
                message: schema22.errorMessage || json_worker_localize2("DisallowedExtraPropWarning", "Property {0} is not allowed.", propertyName)
              });
            } else {
    ...
    if (json_worker_isNumber(schema22.maxProperties)) {
      if (node2.properties.length > schema22.maxProperties) {
        validationResult2.problems.push({
          location: { offset: node2.offset, length: node2.length },
          message: json_worker_localize2("MaxPropWarning", "Object has more properties than limit of {0}.", schema22.maxProperties)
        });
      }
    }
    if (json_worker_isNumber(schema22.minProperties)) {
      if (node2.properties.length < schema22.minProperties) {
        validationResult2.problems.push({
          location: { offset: node2.offset, length: node2.length },
          message: json_worker_localize2("MinPropWarning", "Object has fewer properties than the required number of {0}", schema22.minProperties)
        });
      }
    }
          ...
          if (Array.isArray(propertyDep)) {
            for (var _p = 0, propertyDep_1 = propertyDep; _p < propertyDep_1.length; _p++) {
              ...
              if (!seenKeys[requiredProp]) {
                validationResult2.problems.push({
                  location: { offset: node2.offset, length: node2.length },
                  message: json_worker_localize2("RequiredDependentPropWarning", "Object is missing property {0} required by property {1}.", requiredProp, key)
                });
              } else {
                validationResult2.propertiesValueMatches++;
              }
...
function parse3(textDocument, config) {
  ...
  function _checkScanError() {
    switch (scanner.getTokenError()) {
      case 4:
        _error(json_worker_localize2("InvalidUnicode", "Invalid unicode sequence in string."), ErrorCode.InvalidUnicode);
        return true;
      case 5:
        _error(json_worker_localize2("InvalidEscapeCharacter", "Invalid escape character in string."), ErrorCode.InvalidEscapeCharacter);
        return true;
      case 3:
        _error(json_worker_localize2("UnexpectedEndOfNumber", "Unexpected end of number."), ErrorCode.UnexpectedEndOfNumber);
        return true;
      case 1:
        _error(json_worker_localize2("UnexpectedEndOfComment", "Unexpected end of comment."), ErrorCode.UnexpectedEndOfComment);
        return true;
      case 2:
        _error(json_worker_localize2("UnexpectedEndOfString", "Unexpected end of string."), ErrorCode.UnexpectedEndOfString);
        return true;
      case 6:
        _error(json_worker_localize2("InvalidCharacter", "Invalid characters in string. Control characters must be escaped."), ErrorCode.InvalidCharacter);
        return true;
    }
    return false;
  }
  ...
  function _parseArray(parent) {
    ...
    while (scanner.getToken() !== 4 && scanner.getToken() !== 17) {
      if (scanner.getToken() === 5) {
        if (!needsComma) {
          _error(json_worker_localize2("ValueExpected", "Value expected"), ErrorCode.ValueExpected);
        }
        var commaOffset = scanner.getTokenOffset();
        _scanNext();
        if (scanner.getToken() === 4) {
          if (needsComma) {
            _errorAtRange(json_worker_localize2("TrailingComma", "Trailing comma"), ErrorCode.TrailingComma, commaOffset, commaOffset + 1);
          }
          continue;
        }
      } else if (needsComma) {
        _error(json_worker_localize2("ExpectedComma", "Expected comma"), ErrorCode.CommaExpected);
      }
      var item = _parseValue(node);
      if (!item) {
        _error(json_worker_localize2("PropertyExpected", "Value expected"), ErrorCode.ValueExpected, void 0, [], [
          4,
          5
          /* CommaToken */
        ]);
    ...
    if (scanner.getToken() !== 4) {
      return _error(json_worker_localize2("ExpectedCloseBracket", "Expected comma or closing bracket"), ErrorCode.CommaOrCloseBacketExpected, node);
    }
  ...
  function _parseProperty(parent, keysSeen) {
    ...
    if (!key) {
      if (scanner.getToken() === 16) {
        _error(json_worker_localize2("DoubleQuotesExpected", "Property keys must be doublequoted"), ErrorCode.Undefined);
    ...
    if (seen) {
      _errorAtRange(json_worker_localize2("DuplicateKeyWarning", "Duplicate object key"), ErrorCode.DuplicateKey, node.keyNode.offset, node.keyNode.offset + node.keyNode.length, DiagnosticSeverity.Warning);
      if (typeof seen === "object") {
        _errorAtRange(json_worker_localize2("DuplicateKeyWarning", "Duplicate object key"), ErrorCode.DuplicateKey, seen.keyNode.offset, seen.keyNode.offset + seen.keyNode.length, DiagnosticSeverity.Warning);
      }
    ...
    if (scanner.getToken() === 6) {
      ...
      _error(json_worker_localize2("ColonExpected", "Colon expected"), ErrorCode.ColonExpected);
    ...
    if (!value) {
      return _error(json_worker_localize2("ValueExpected", "Value expected"), ErrorCode.ValueExpected, node, [], [
        2,
        5
        /* CommaToken */
      ]);
  ...
  function _parseObject(parent) {
    ...
    while (scanner.getToken() !== 2 && scanner.getToken() !== 17) {
      if (scanner.getToken() === 5) {
        if (!needsComma) {
          _error(json_worker_localize2("PropertyExpected", "Property expected"), ErrorCode.PropertyExpected);
        }
        var commaOffset = scanner.getTokenOffset();
        _scanNext();
      ...
      if (!property2) {
        _error(json_worker_localize2("PropertyExpected", "Property expected"), ErrorCode.PropertyExpected, void 0, [], [
          2,
          5
          /* CommaToken */
        ]);
    ...
    if (scanner.getToken() !== 2) {
      return _error(json_worker_localize2("ExpectedCloseBrace", "Expected comma or closing brace"), ErrorCode.CommaOrCloseBraceExpected, node);
    }
    return _finalize(node, true);
  }
    ...
    if (scanner.getTokenError() === 0) {
      ...
      try {
        ...
        if (!json_worker_isNumber(numberValue)) {
          return _error(json_worker_localize2("InvalidNumberFormat", "Invalid number format."), ErrorCode.Undefined, node);
        }
  ...
  if (token !== 17) {
    ...
    if (!_root) {
      _error(json_worker_localize2("Invalid symbol", "Expected a JSON object, array or literal."), ErrorCode.Undefined);
    } else if (scanner.getToken() !== 17) {
      _error(json_worker_localize2("End of file expected", "End of file expected."), ErrorCode.Undefined);
    }
  }
...
var JSONCompletion = (
  ...
  function() {
    ...
    JSONCompletion2.prototype.addDefaultValueCompletions = function(schema2, separatorAfter, collector, arrayDepth) {
      ...
      if (json_worker_isDefined(schema2.default)) {
    ...
    JSONCompletion2.prototype.collectTypes = function(schema2, types) {
      if (Array.isArray(schema2.enum) || json_worker_isDefined(schema2.const)) {
        return;
      }
      var type = schema2.type;
            ...
            if (item.type === "object") {
              for (var _b = 0, _c = item.properties; _b < _c.length; _b++) {
                ...
                if (property2.keyNode.value === "key" && property2.valueNode) {
                  ...
                  result_1.push({ name: getNodeValue3(property2.valueNode), kind: json_worker_SymbolKind.Function, location });
                  limit--;
                  if (limit <= 0) {
            ...
            if (item.type === "object") {
              for (var _b = 0, _c = item.properties; _b < _c.length; _b++) {
                ...
                if (property2.keyNode.value === "key" && property2.valueNode) {
                  ...
                  result_2.push({ name: getNodeValue3(property2.valueNode), kind: json_worker_SymbolKind.Function, range, selectionRange });
                  limit--;
                  if (limit <= 0) {
                    if (context && context.onResultLimitExceeded) {
                      context.onResultLimitExceeded(resourceString);
  ...
  var t = { 470: (t2) => {
    ...
    var n = { resolve: function() {
      for (var t3, n2 = "", o = false, i = arguments.length - 1; i >= -1 && !o; i--) {
        var a2;
        i >= 0 ? a2 = arguments[i] : (void 0 === t3 && (t3 = json_worker_process.cwd()), a2 = t3), e2(a2), 0 !== a2.length && (n2 = a2 + "/" + n2, o = 47 === a2.charCodeAt(0));
      }
    ...
    var n;
    if (r2.r(e2), r2.d(e2, { URI: () => d, Utils: () => P }), "object" == typeof json_worker_process)
      n = "win32" === json_worker_process.platform;
